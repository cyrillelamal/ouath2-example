...
const CLIENT_ID = ""; // The client ID you received from GitHub when you registered.
...
const CLIENT_SECRET = ""; // The client secret you received from GitHub for your OAuth App.
